...
Weiterhin entscheidend ist die Auswahl der abzubildenden Klassen oder alternativ des abzubildenden Models. MIREX gibt die in Tabelle 4 gezeigten Klassen vor:
\begin{center}
\begin{figure}[h]
...
rowdy & amiable/good natured & autumnal & whimsical & volatile \\
 & & brooding & witty & visceral \\
  & & & wry &
\end{tabular}
\caption[MIREX Music Emotion Recognition Klassen]{MIREX Music Emotion Recognition Klassen}
\end{figure}
\end{center}
Auch andere Klasseneinteilungen sind möglich, so erarbeitet Janto Skowronek, Martin McKinney und Steven van de Par
 \cite{7cd5f337a4b030e3fafd0b4bc7e0976ff7cc1ec8c28d583c5dab695e0ee78941} die in Tabelle 5 gezeigten Klassen.
...
romantic &          & strong   &     & jittery  & tender\\
         &          &          &     & nervous  & \\
         &          &          &     &          & \\       \end{tabular}
\caption[Alternative Music Emotion Recognition Klassen]{Alternative Music Emotion Recognition Klassen}
\end{figure}
\end{center}
