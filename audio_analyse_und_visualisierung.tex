...
Um die Umwandlung von unbearbeiteten Audiosignalen in eine passende Visualisierung zu vereinfachen, wird die Aufgabenstellung in mehrere Teilschritte gegliedert. Als Ausgangspunkt existiert eine persistente Audiodatei.\\
...
Das Verhalten von Movables wird über ``Movements'' realisiert. Movements können einer Movable-Instanz oder einer Gruppe von Movables zugeordnet werden, um das Verhalten dieser zu verändern.\\
...
Abbildung \ref{fig:AufbauVisualizer} zeigt ein UML Diagramm, das den Aufbau des Visualizers zeigt.

\begin{figure}[!ht]
\centering
\includegraphics[scale=0.65]{res/diagrams/VisualizerClassDiagram}
