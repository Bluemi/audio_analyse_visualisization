...
\draw[thin, ->] (0, 0) -- (0, 1.7) node[above] {$f(x)$};
...
\end{tikzpicture}
\caption[Zufallsfolge $\left(f_i\right)$ und Interpolation]{Zufallsfolge $\left(f_i\right)$ mit Interpolation und Interpolationspolynom $f(x)$}
\end{figure}
\end{center}



% Implementation Perlin Noise, Optimierung
% genaue Interaktion mit Perlin Noise
% einbeziehen der Zeit

% _force und Einwirkung von BeatEvents
% PlainForce
